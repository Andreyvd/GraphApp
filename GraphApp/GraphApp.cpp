...
// GraphApp.cpp: определяет поведение классов для приложения.
//
...
CGraphApp::CGraphApp() noexcept
{
	...
	SetAppID(_T("GraphApp.AppID.NoVersion"));
...
// Обработчики сообщений CGraphApp
...
// Методы загрузки или сохранения настроек CGraphApp
